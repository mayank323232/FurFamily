...
class _DonationsScreenState extends State<DonationsScreen> {
  ...
  List<Map<String, String>> _donationHistory = [];
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          leading: Icon(Icons.favorite, color: Color(0xFF5A3E36)),
                          title: Text("${donation['name']} donated ₹${donation['amount']}",
                              style: GoogleFonts.poppins(fontWeight: FontWeight.w500)),
                          subtitle: Text("via ${donation['method']}",
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'assets/donation_success.png', // <- Put your animation here
                height: 200,
              ),
              SizedBox(height: 30),
              Text(
